...
type ModalReconhecimentoProps = {
    visivel: boolean,
    setModalVisivel : () => void,
}

export const ModalReconhecimento = (props: ModalReconhecimentoProps) => {
    if (props.visivel) {
        return (
            <div className='modal'>
                <div className='modal--container'>
                    ...
                    <div className='container-botoes'>
                        <button className='botao botao-borda-rosa' onClick={props.setModalVisivel}> Cancelar </button>
